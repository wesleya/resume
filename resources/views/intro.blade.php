<div class="jumbotron jumbotron-fluid" style="background-color: transparent;">
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-3" style="padding-bottom: 15px;">
            ...
            <div class="col-xs-12 col-sm-3" style="padding-bottom: 15px;">
                <a class="btn btn-primary btn-lg btn-block" href="#experience" role="button">Experience</a>
            </div>
            <div class="col-xs-12 col-sm-3" style="padding-bottom: 15px;">
                <a class="btn btn-primary btn-lg btn-block" href="#contact" role="button">Contact</a>
            </div>
        </div>
    </div>
</div>